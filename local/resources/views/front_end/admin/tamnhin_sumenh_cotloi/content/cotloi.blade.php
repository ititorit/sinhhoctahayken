...
@section('header-admin-home')
    Chỉnh sửa :: <kbd>{{ isset($cotloi->title) ? $cotloi->title : null }}</kbd>
@endsection
		...
		<div class="col-md-6">
			...
			<form method="POST">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="Nhập vào tiêu đề" name="title" value="{{ isset($cotloi->title) ? $cotloi->title : null }}">
				</div>
				@if($errors->has('title'))
				...
				<div class="form-group">
					...
					<textarea name="content" id="content-box">{!! isset($cotloi->content) ? $cotloi->content : null !!}</textarea>
